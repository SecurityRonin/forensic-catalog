...
- URL: https://windowsir.blogspot.com/2013/03/there-are-four-lights-program-execution.html
- Published: unknown
- Updated: unknown
- Labels: none
...
as well as the book I co-authored with Cory Altheide, "Digital Forensics with Open Source Tools".
 ...
 So, you were able to run the RegRipper UserAssist plugin against the NTUSER.DAT? How about the appcompatcache.pl plugin against the System hive?
 Sorry for the delayed reply. My shifts are a little crazy this week.

 I ran the appcompatcache.pl plugin against the System hive and found more evidence of several programs I was interested in being run. I'm still going through all the output, but RR with this plugin definitely provided useful information.
 KP
 Ken,

 Interesting comment, thanks. I DM'd you on Twitter with a question...sorry, I don't have an email address for you...
 Post a Comment
 Pages
 Home
 Timelines
...
Investigate. 2 weeks ago
 ...
 ► May (4)
 ► April (9)
 ▼ March (5) There Are Four Lights: Malware Indicators in the R...
 Links
 There are Four Lights: Program Execution
