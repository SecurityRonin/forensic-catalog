...
- URL: https://windowsir.blogspot.com/2015/09/updates-links-etc.html
- Published: unknown
- Updated: unknown
- Labels: none
...
as well as the book I co-authored with Cory Altheide, "Digital Forensics with Open Source Tools".
 ...
 5 comments:
 Is the github site still the correct location to download the latest version of regripper? I don't see the new malware plugin in the folder and the environment plugin shows it was last updated almost a year ago.
 Yes, it is. Try it again. I pushed them out again to be sure.
 That worked. Thanks.
 I'd greatly appreciate any feedback on the malware.pl plugin...
 In regards to the SC article section, how about the times we get called in after IT has blasted the machine with AV scans days later? Doesn't help.
 Post a Comment
 Pages
 Home
 Timelines
