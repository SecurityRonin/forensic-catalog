//! YARA rule name → MITRE ATT&CK technique lookup.
//!
//! Maps common YARA rule name prefixes (e.g. `"ransomware_"`, `"rootkit_"`)
//! to MITRE ATT&CK technique IDs, tactics, and human-readable names.
//! Used by DFIR tools (e.g. blazehash) to enrich YARA scan results without
//! embedding forensic knowledge in the tool itself.
