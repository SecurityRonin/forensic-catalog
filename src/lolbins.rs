...
pub const LOLBAS_LINUX: &[LolbasEntry] = &[
    LolbasEntry {
        ...
        mitre_techniques: &["T1560.001"],
        use_cases: UC_ARCHIVE,
        description: "Archive and extract files; stage data for exfiltration.",
    },
    LolbasEntry {
        name: "aa-exec",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD,
        description: "Multi-protocol downloader; parallel payload delivery.",
    },
    LolbasEntry {
        name: "arj",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Text processing language; shell escape and file read/write.",
    },
    LolbasEntry {
        name: "aws",
    ...
    LolbasEntry {
        name: "base64",
        mitre_techniques: &["T1140", "T1027"],
        use_cases: UC_DECODE,
        description: "Encode/decode base64; obfuscate payloads and exfiltrate data.",
    },
    LolbasEntry {
        name: "basenc",
        mitre_techniques: &["T1140"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.004"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Bourne-again shell; execution, SUID abuse, and reverse shells.",
    },
    LolbasEntry {
        name: "bashbug",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.004"],
        use_cases: UC_EXECUTE,
        description: "Multi-call binary; shell and utility execution in minimal environments.",
    },
    LolbasEntry {
        name: "byebug",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Linux capability shell wrapper; capability-based privilege escalation.",
    },
    LolbasEntry {
        name: "cargo",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1548.001"],
        use_cases: UC_BYPASS,
        description: "File permission modification; set SUID bits for privilege escalation.",
    },
    LolbasEntry {
        name: "choom",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Change root directory; container escape and privilege escalation.",
    },
    LolbasEntry {
        name: "chrt",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "cpio",
        mitre_techniques: &["T1560.001"],
        use_cases: UC_ARCHIVE | UC_EXECUTE,
        description: "",
    },
    LolbasEntry {
        name: "cpulimit",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1053.003"],
        use_cases: UC_PERSIST,
        description: "Cron job management; establish periodic execution persistence.",
    },
    LolbasEntry {
        name: "csh",
        mitre_techniques: &["T1059.004"],
    ...
    LolbasEntry {
        ...
        use_cases: UC_DOWNLOAD | UC_UPLOAD,
        description: "HTTP/HTTPS/FTP client; payload delivery and data exfiltration.",
    },
    LolbasEntry {
        name: "cut",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "dd",
        mitre_techniques: &["T1548.001", "T1003"],
        use_cases: UC_BYPASS | UC_CREDENTIALS,
        description: "Raw disk read/write; disk image creation and SUID-based file overwrite.",
    },
    LolbasEntry {
        name: "debugfs",
        mitre_techniques: &["T1548"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "ext2/3/4 debugger; bypass filesystem permissions for privileged access.",
    },
    LolbasEntry {
        name: "dhclient",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1018"],
        use_cases: UC_RECON,
        description: "DNS query tool; infrastructure mapping and C2 DNS beacon testing.",
    },
    LolbasEntry {
        name: "distcc",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_BYPASS | UC_EXECUTE,
        description: "",
    },
    LolbasEntry {
        name: "docker",
        ...
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Container runtime; breakout via privileged containers or socket abuse.",
    },
    LolbasEntry {
        name: "dos2unix",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.004"],
        use_cases: UC_EXECUTE,
        description: "Extensible text editor; shell escape via M-x shell or eval.",
    },
    LolbasEntry {
        name: "enscript",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Set environment and run command; bypass shebangs and allowlists.",
    },
    LolbasEntry {
        name: "eqn",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Interactive process automation; abuse interactive prompts and spawn shells.",
    },
    LolbasEntry {
        name: "facter",
        mitre_techniques: &["T1082"],
    ...
    LolbasEntry {
        name: "find",
        mitre_techniques: &["T1083", "T1548.001"],
        use_cases: UC_RECON | UC_EXECUTE | UC_BYPASS,
        description: "File discovery with exec; SUID abuse and shell escape via -exec.",
    },
    LolbasEntry {
        name: "finger",
        mitre_techniques: &["T1087"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD,
        description: "FTP client; file transfer and interactive shell escape.",
    },
    LolbasEntry {
        name: "fzf",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_CREDENTIALS,
        description: "Generate core dump of process; extract credentials from memory.",
    },
    LolbasEntry {
        name: "gdb",
        mitre_techniques: &["T1055"],
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "GNU debugger; process memory injection and credential extraction via ptrace.",
    },
    LolbasEntry {
        name: "gem",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105"],
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Git VCS client; clone payloads and execute hooks for code execution.",
    },
    LolbasEntry {
        name: "gnuplot",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_RECON,
        description: "Search files for patterns; credential discovery in config files.",
    },
    LolbasEntry {
        name: "gtester",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_CREDENTIALS,
        description: "GPU password cracker; offline credential recovery.",
    },
    LolbasEntry {
        name: "hd",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1548.001"],
        use_cases: UC_BYPASS,
        description: "Install files with permissions; copy files with arbitrary ownership/mode.",
    },
    LolbasEntry {
        name: "ionice",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1016"],
        use_cases: UC_RECON | UC_NETWORK,
        description: "IP routing and interface management; network config enumeration.",
    },
    LolbasEntry {
        name: "iptables-save",
        mitre_techniques: &["T1016"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1654"],
        use_cases: UC_RECON | UC_EXECUTE,
        description: "Systemd log viewer; log review and shell escape via pager.",
    },
    LolbasEntry {
        name: "jq",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "Kubernetes CLI; secret extraction, pod exec, RBAC abuse.",
    },
    LolbasEntry {
        name: "last",
        mitre_techniques: &["T1087"],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Dynamic linker; preload libraries to hijack function calls.",
    },
    LolbasEntry {
        name: "ldconfig",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Pager with shell escape via !command or v in vi mode.",
    },
    LolbasEntry {
        name: "lftp",
        mitre_techniques: &["T1105"],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "LXD container manager; container escape to root via image import.",
    },
    LolbasEntry {
        name: "m4",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_UPLOAD | UC_EXECUTE,
        description: "",
    },
    LolbasEntry {
        name: "make",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Build system; arbitrary command execution via Makefile targets.",
    },
    LolbasEntry {
        name: "man",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Manual page viewer; shell escape via pager.",
    },
    LolbasEntry {
        name: "mawk",
        mitre_techniques: &["T1059.004"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Legacy pager; shell escape via !shell on some implementations.",
    },
    LolbasEntry {
        name: "mosh-server",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "MySQL client; data exfiltration and LOAD DATA INFILE abuse.",
    },
    LolbasEntry {
        name: "nano",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105", "T1071.001"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD | UC_NETWORK,
        description: "Netcat; reverse shells, file transfer, and port scanning.",
    },
    LolbasEntry {
        name: "ncdu",
        mitre_techniques: &["T1083"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1046"],
        use_cases: UC_RECON | UC_NETWORK,
        description: "Port scanner; network discovery, OS fingerprinting, script execution.",
    },
    LolbasEntry {
        name: "node",
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "Node.js runtime; eval-based code execution, reverse shells.",
    },
    LolbasEntry {
        name: "nohup",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1611"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Enter Linux namespaces; container escape via host PID namespace.",
    },
    LolbasEntry {
        name: "ntpdate",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "openssl",
        mitre_techniques: &["T1552.004", "T1105"],
        use_cases: UC_CREDENTIALS | UC_DOWNLOAD | UC_DECODE,
        description: "TLS toolkit; generate self-signed certs, encrypt data, download files.",
    },
    LolbasEntry {
        name: "openvpn",
    ...
    LolbasEntry {
        name: "perl",
        mitre_techniques: &["T1059.006", "T1105"],
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Perl interpreter; shell exec, network downloads, SUID abuse.",
    },
    LolbasEntry {
        name: "perlbug",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "PHP CLI; eval-based code execution and system command invocation.",
    },
    LolbasEntry {
        name: "pic",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1548.001"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Polkit exec; CVE-2021-4034 (PwnKit) privilege escalation vector.",
    },
    LolbasEntry {
        name: "pkg",
        mitre_techniques: &["T1072"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1005"],
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "PostgreSQL client; data exfiltration and pg_read_file abuse.",
    },
    LolbasEntry {
        name: "ptx",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.006", "T1105"],
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Python interpreter; reverse shells, network downloads, SUID abuse.",
    },
    LolbasEntry {
        name: "qpdf",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "restic",
        mitre_techniques: &["T1560"],
        use_cases: UC_ARCHIVE | UC_UPLOAD,
        description: "Backup tool; encrypted data exfiltration to remote repositories.",
    },
    LolbasEntry {
        name: "rev",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "rsync",
        mitre_techniques: &["T1105", "T1039"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD | UC_NETWORK,
        description: "File sync; lateral movement data staging and exfiltration.",
    },
    LolbasEntry {
        name: "rsyslogd",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Ruby interpreter; shell escape, network requests, file system access.",
    },
    LolbasEntry {
        name: "run-mailcap",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        use_cases: UC_DOWNLOAD | UC_UPLOAD | UC_NETWORK,
        description: "Secure copy over SSH; file exfiltration and lateral movement.",
    },
    LolbasEntry {
        name: "screen",
        mitre_techniques: &["T1548.001"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Terminal multiplexer with SUID abuse; persistent session and privilege esc.",
    },
    LolbasEntry {
        name: "script",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.004"],
        use_cases: UC_EXECUTE,
        description: "POSIX shell; universal execution and SUID privilege escalation.",
    },
    LolbasEntry {
        name: "shred",
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Secure file deletion; overwrite and delete evidence.",
    },
    LolbasEntry {
        name: "shuf",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "smbclient",
        mitre_techniques: &["T1021.002"],
        use_cases: UC_NETWORK | UC_DOWNLOAD,
        description: "",
    },
    LolbasEntry {
        name: "snap",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105", "T1071.001"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD | UC_NETWORK,
        description: "Socket relay; reverse shells, port forwarding, C2 channels.",
    },
    LolbasEntry {
        name: "socket",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "sqlite3",
        mitre_techniques: &["T1539", "T1005"],
        use_cases: UC_CREDENTIALS | UC_RECON,
        description: "SQLite CLI; extract cookies and credentials from browser/app databases.",
    },
    LolbasEntry {
        name: "sqlmap",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1049"],
        use_cases: UC_RECON,
        description: "Socket statistics; enumerate network connections and listening services.",
    },
    LolbasEntry {
        name: "ssh",
        mitre_techniques: &["T1021.004"],
        use_cases: UC_NETWORK | UC_EXECUTE,
        description: "SSH client; lateral movement, tunneling, and port forwarding.",
    },
    LolbasEntry {
        name: "ssh-agent",
    ...
    LolbasEntry {
        name: "ssh-keygen",
        mitre_techniques: &["T1552.004"],
        use_cases: UC_CREDENTIALS | UC_PERSIST,
        description: "",
    },
    LolbasEntry {
        name: "ssh-keyscan",
    ...
    LolbasEntry {
        ...
        use_cases: UC_CREDENTIALS | UC_NETWORK,
        description: "",
    },
    LolbasEntry {
        name: "sshuttle",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1055"],
        use_cases: UC_CREDENTIALS,
        description: "System call tracer; intercept credentials from processes via ptrace.",
    },
    LolbasEntry {
        name: "strings",
        mitre_techniques: &["T1003"],
        use_cases: UC_CREDENTIALS,
        description: "Extract printable strings; credential discovery in binary files/dumps.",
    },
    LolbasEntry {
        name: "su",
        mitre_techniques: &["T1548.003"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1548.003"],
        use_cases: UC_BYPASS | UC_EXECUTE,
        description: "Superuser do; most common Unix privilege escalation mechanism.",
    },
    LolbasEntry {
        name: "sysctl",
        mitre_techniques: &["T1082"],
    ...
    LolbasEntry {
        ...
        use_cases: UC_PERSIST | UC_EXECUTE,
        description: "Systemd service manager; create and start services for persistence.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Run commands as systemd transient units; container escape and evasion.",
    },
    LolbasEntry {
        name: "tac",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        name: "tar",
        mitre_techniques: &["T1560.001", "T1548.001"],
        use_cases: UC_ARCHIVE | UC_BYPASS,
        description: "Archive utility; data staging and SUID-based privilege escalation.",
    },
    LolbasEntry {
        name: "task",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1040"],
        use_cases: UC_CREDENTIALS | UC_RECON,
        description: "Packet capture; credential harvesting from cleartext protocols.",
    },
    LolbasEntry {
        name: "tcsh",
        mitre_techniques: &["T1059.004"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1548.001"],
        use_cases: UC_BYPASS,
        description: "Write to file with SUID; append to privileged files like /etc/sudoers.",
    },
    LolbasEntry {
        name: "telnet",
        mitre_techniques: &["T1021"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD,
        description: "TFTP client; file transfer on port 69, often unmonitored.",
    },
    LolbasEntry {
        name: "tic",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Terminal multiplexer; persistent session and SUID abuse.",
    },
    LolbasEntry {
        name: "top",
        mitre_techniques: &["T1057"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1611"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Create new Linux namespaces; container escape and user NS privilege esc.",
    },
    LolbasEntry {
        name: "unsquashfs",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Text editor; shell escape via :!shell or :shell command.",
    },
    LolbasEntry {
        name: "view",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Vi improved; shell escape, file read/write, and Python exec.",
    },
    LolbasEntry {
        name: "vimdiff",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD,
        description: "HTTP/HTTPS downloader; payload delivery and data staging.",
    },
    LolbasEntry {
        name: "whiptail",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Argument builder; execute commands over many arguments, bypass restrictions.",
    },
    LolbasEntry {
        name: "xdg-user-dir",
        mitre_techniques: &["T1083"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1140"],
        use_cases: UC_DECODE,
        description: "Hex dump and conversion; encode/decode binary payloads.",
    },
    LolbasEntry {
        name: "xz",
        mitre_techniques: &["T1560.001"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.004"],
        use_cases: UC_EXECUTE,
        description: "Z shell; execution, interactive exploitation, and SUID abuse.",
    },
    LolbasEntry {
        name: "zsoelim",
        mitre_techniques: &[],
...
pub const LOLBAS_MACOS: &[LolbasEntry] = &[
    ...
    LolbasEntry {
        ...
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "Execute AppleScript/JXA; credential phishing and lateral movement via RAE.",
    },
    LolbasEntry {
        name: "osacompile",
        mitre_techniques: &["T1059.002"],
        use_cases: UC_EXECUTE | UC_PERSIST,
        description: "Compile AppleScript to app bundle; create persistence payload.",
    },
    LolbasEntry {
        name: "swift",
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "Swift REPL; direct system API access without shell.",
    },
    LolbasEntry {
        name: "tclsh",
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "Tcl interpreter; execution without shell involvement.",
    },
    // Persistence / launch services
    LolbasEntry {
        name: "launchctl",
        mitre_techniques: &["T1543.001", "T1543.004"],
        use_cases: UC_PERSIST | UC_DEFENSE_EVASION,
        description: "Load/unload LaunchAgents and Daemons; primary macOS persistence vector.",
    },
    LolbasEntry {
        name: "lsregister",
        mitre_techniques: &["T1574"],
        use_cases: UC_PERSIST,
        description: "Launch Services DB manipulation; file association hijacking.",
    },
    // Credential access
    LolbasEntry {
        name: "security",
        mitre_techniques: &["T1003.002", "T1553.004"],
        use_cases: UC_CREDENTIALS | UC_BYPASS,
        description: "Keychain dump, certificate manipulation, and credential extraction.",
    },
    LolbasEntry {
        name: "dscl",
        mitre_techniques: &["T1078", "T1087"],
        use_cases: UC_RECON | UC_CREDENTIALS,
        description: "Directory Services CLI; user/group enumeration and modification.",
    },
    LolbasEntry {
        name: "dscacheutil",
        mitre_techniques: &["T1087"],
        use_cases: UC_RECON,
        description: "DS cache flushing and user enumeration.",
    },
    LolbasEntry {
        name: "odutil",
        mitre_techniques: &["T1087"],
        use_cases: UC_RECON,
        description: "Open Directory utility; directory service inspection.",
    },
    LolbasEntry {
        name: "dsconfigad",
        mitre_techniques: &["T1087.002"],
        use_cases: UC_RECON,
        description: "Active Directory binding configuration and inspection.",
    },
    LolbasEntry {
        name: "dsexport",
        mitre_techniques: &["T1087"],
        use_cases: UC_RECON,
        description: "Export directory records; user/group data collection.",
    },
    LolbasEntry {
        name: "sysadminctl",
        mitre_techniques: &["T1136.001"],
        use_cases: UC_CREDENTIALS | UC_EXECUTE,
        description: "Create/modify local user accounts; privilege escalation vector.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "Full hardware/software/network inventory.",
    },
    LolbasEntry {
        name: "networksetup",
        mitre_techniques: &["T1016", "T1090"],
        use_cases: UC_RECON | UC_NETWORK,
        description: "Network interface enumeration and proxy C2 configuration.",
    },
    LolbasEntry {
        name: "scutil",
        mitre_techniques: &["T1082", "T1016"],
        use_cases: UC_RECON,
        description: "System configuration inspection (hostname, DNS, proxy).",
    },
    LolbasEntry {
        name: "sw_vers",
        mitre_techniques: &["T1082"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "Kernel parameter inspection (memory, CPU, network).",
    },
    LolbasEntry {
        name: "ioreg",
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "IOKit registry; hardware device enumeration.",
    },
    LolbasEntry {
        name: "kextstat",
        mitre_techniques: &["T1518.001"],
        use_cases: UC_RECON,
        description: "Kernel extension enumeration; security tool detection.",
    },
    LolbasEntry {
        name: "profiles",
        mitre_techniques: &["T1518"],
        use_cases: UC_RECON,
        description: "MDM/configuration profile enumeration.",
    },
    LolbasEntry {
        name: "last",
        mitre_techniques: &["T1087"],
        use_cases: UC_RECON,
        description: "Login history; user activity reconstruction.",
    },
    LolbasEntry {
        name: "mdfind",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Spotlight search; locate files without filesystem walk.",
    },
    LolbasEntry {
        name: "mdls",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Spotlight metadata; file attribute inspection.",
    },
    LolbasEntry {
        name: "defaults",
    ...
    LolbasEntry {
        ...
        use_cases: UC_RECON | UC_PERSIST,
        description: "Plist manipulation; launch agent config modification.",
    },
    LolbasEntry {
        name: "sharing",
        mitre_techniques: &["T1135"],
        use_cases: UC_RECON,
        description: "File sharing configuration; SMB/AFP exposure enumeration.",
    },
    LolbasEntry {
        name: "systemsetup",
        mitre_techniques: &["T1082", "T1021.004"],
        use_cases: UC_RECON | UC_NETWORK,
        description: "System preferences modification (remote login, time server).",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1548"],
        use_cases: UC_BYPASS,
        description: "TCC database reset; bypass macOS privacy controls.",
    },
    LolbasEntry {
        name: "csrutil",
        mitre_techniques: &["T1553"],
        use_cases: UC_BYPASS | UC_RECON,
        description: "SIP status check; disable System Integrity Protection.",
    },
    LolbasEntry {
        name: "spctl",
        mitre_techniques: &["T1553.001"],
        use_cases: UC_BYPASS,
        description: "Gatekeeper bypass assessment; check and modify code signing policy.",
    },
    LolbasEntry {
        name: "codesign",
        mitre_techniques: &["T1553.001"],
        use_cases: UC_BYPASS,
        description: "Code signature verification and self-signing for trust bypass.",
    },
    LolbasEntry {
        name: "chflags",
        mitre_techniques: &["T1564.001"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Set immutable/hidden flags on files; tamper with forensic artifacts.",
    },
    LolbasEntry {
        name: "xattr",
        mitre_techniques: &["T1553.001"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Extended attribute manipulation; quarantine flag removal.",
    },
    LolbasEntry {
        name: "nvram",
        mitre_techniques: &["T1542"],
        use_cases: UC_PERSIST,
        description: "NVRAM variable read/write; firmware-level persistence.",
    },
    LolbasEntry {
        name: "sfltool",
        mitre_techniques: &["T1543.001"],
        use_cases: UC_PERSIST,
        description: "SharedFileList manipulation; login item modification.",
    },
    // Exfiltration / file operations
    LolbasEntry {
        name: "hdiutil",
        mitre_techniques: &["T1560", "T1490"],
        use_cases: UC_ARCHIVE | UC_EXECUTE,
        description: "Disk image creation/mount; data staging and exfiltration.",
    },
    LolbasEntry {
        name: "ditto",
        mitre_techniques: &["T1036"],
        use_cases: UC_EXECUTE,
        description: "Copy files preserving metadata; stealthy file staging.",
    },
    LolbasEntry {
        name: "tmutil",
        mitre_techniques: &["T1490"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Time Machine control; backup manipulation or data recovery.",
    },
    LolbasEntry {
        name: "screencapture",
        mitre_techniques: &["T1113"],
        use_cases: UC_RECON,
        description: "Screen capture; visual data collection.",
    },
    LolbasEntry {
        name: "pbpaste",
        mitre_techniques: &["T1115"],
        use_cases: UC_RECON,
        description: "Clipboard access; credential and data collection.",
    },
    LolbasEntry {
        name: "sqlite3",
        mitre_techniques: &["T1539", "T1005"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Document format conversion; data exfiltration staging.",
    },
    LolbasEntry {
        name: "funzip",
        mitre_techniques: &["T1140"],
        use_cases: UC_DECODE,
        description: "Unzip from stdin; payload unpacking without writing temp files.",
    },
    LolbasEntry {
        name: "streamzip",
        mitre_techniques: &["T1560"],
        use_cases: UC_ARCHIVE,
        description: "Zip streaming; data archiving without GUI interaction.",
    },
    // Network / C2
    LolbasEntry {
        name: "nscurl",
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD,
        description: "NSURLSession-based curl; TLS downloads bypassing some controls.",
    },
    LolbasEntry {
        name: "tftp",
        mitre_techniques: &["T1105"],
    ...
    LolbasEntry {
        ...
        use_cases: UC_NETWORK,
        description: "SNMP trap sender; covert C2 over SNMP.",
    },
    LolbasEntry {
        name: "dns-sd",
        mitre_techniques: &["T1046"],
        use_cases: UC_RECON | UC_NETWORK,
        description: "DNS service discovery; network recon and mDNS C2.",
    },
    LolbasEntry {
        name: "ssh-keygen",
        mitre_techniques: &["T1552.004"],
        use_cases: UC_CREDENTIALS | UC_PERSIST,
        description: "Generate/manage SSH keys; persistence via authorized_keys.",
    },
    // Miscellaneous
    LolbasEntry {
        name: "open",
        ...
        use_cases: UC_EXECUTE,
        description: "Open URLs/apps; browser redirect and app launch.",
    },
    LolbasEntry {
        name: "say",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Prevent system sleep; keep C2 beacon alive during long operations.",
    },
    LolbasEntry {
        name: "pkill",
        mitre_techniques: &["T1562.001"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1654"],
        use_cases: UC_RECON,
        description: "macOS Unified Log streaming; surveillance and anti-forensics awareness.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1078.004"],
        use_cases: UC_CREDENTIALS | UC_EXECUTE,
        description: "AWS CLI; credential exfil, S3 staging, IAM enumeration.",
    },
    LolbasEntry {
        name: "az",
        mitre_techniques: &["T1078.004"],
        use_cases: UC_CREDENTIALS | UC_EXECUTE,
        description: "Azure CLI; credential access, storage exfil, AAD recon.",
    },
    LolbasEntry {
        name: "gcloud",
        mitre_techniques: &["T1078.004"],
        use_cases: UC_CREDENTIALS | UC_EXECUTE,
        description: "Google Cloud CLI; GCS exfil, IAM privilege escalation.",
    },
    LolbasEntry {
        name: "gh",
        mitre_techniques: &["T1078"],
        use_cases: UC_CREDENTIALS | UC_EXECUTE,
        description: "GitHub CLI; token access, repo exfil, Actions abuse.",
    },
    LolbasEntry {
        name: "heroku",
        mitre_techniques: &["T1078.004"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1552"],
        use_cases: UC_CREDENTIALS,
        description: "HashiCorp Vault CLI; secret extraction and token abuse.",
    },
    LolbasEntry {
        name: "consul",
        mitre_techniques: &["T1046"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.006", "T1105"],
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Python REPL; code exec, network downloads, C extension loading.",
    },
    LolbasEntry {
        name: "node",
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "Node.js runtime; eval-based exec and npm script abuse.",
    },
    LolbasEntry {
        name: "ruby",
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "Ruby interpreter; shell escape and Gem abuse.",
    },
    LolbasEntry {
        name: "go",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059"],
        use_cases: UC_EXECUTE,
        description: "PHP CLI; eval exec and webshell staging.",
    },
    LolbasEntry {
        name: "perl",
        mitre_techniques: &["T1059.006"],
        use_cases: UC_EXECUTE,
        description: "Perl interpreter; shell exec and regex-based data extraction.",
    },
    // Package managers
    LolbasEntry {
        name: "brew",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Homebrew; malicious tap installation and formula abuse.",
    },
    LolbasEntry {
        name: "pip3",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Python packages; supply chain and code exec via setup.py.",
    },
    LolbasEntry {
        name: "npm",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Node packages; postinstall scripts and typosquatting attacks.",
    },
    LolbasEntry {
        name: "yarn",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "IaC; cloud resource creation and credential leakage via state files.",
    },
    LolbasEntry {
        name: "ansible",
        mitre_techniques: &["T1072"],
        use_cases: UC_EXECUTE,
        description: "Configuration management; mass remote exec via playbooks.",
    },
    LolbasEntry {
        name: "vagrant",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1005"],
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "PostgreSQL client; data exfil and pg_read_file abuse.",
    },
    LolbasEntry {
        name: "mysql",
        mitre_techniques: &["T1005"],
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "MySQL client; data exfil and LOAD DATA INFILE abuse.",
    },
    LolbasEntry {
        name: "redis-cli",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Redis client; config rewrite and RCE via SLAVEOF.",
    },
    LolbasEntry {
        name: "mongosh",
        mitre_techniques: &["T1059"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1046"],
        use_cases: UC_RECON | UC_NETWORK,
        description: "Port scanner; network recon and OS fingerprinting.",
    },
    LolbasEntry {
        name: "socat",
        mitre_techniques: &["T1105", "T1071.001"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD | UC_NETWORK,
        description: "Network relay; reverse shells and port forwarding.",
    },
    LolbasEntry {
        name: "mitmproxy",
        mitre_techniques: &["T1557"],
        use_cases: UC_CREDENTIALS | UC_NETWORK,
        description: "MITM proxy; credential interception and traffic analysis.",
    },
    LolbasEntry {
        name: "tshark",
        mitre_techniques: &["T1040"],
        use_cases: UC_CREDENTIALS | UC_RECON,
        description: "CLI packet capture; credential harvesting and recon.",
    },
    LolbasEntry {
        name: "masscan",
        mitre_techniques: &["T1046"],
    ...
    LolbasEntry {
        ...
        use_cases: UC_NETWORK,
        description: "Reverse tunnel; C2 over HTTPS/TCP bypassing firewalls.",
    },
    LolbasEntry {
        name: "cloudflared",
        mitre_techniques: &["T1572"],
        use_cases: UC_NETWORK,
        description: "Cloudflare Tunnel; C2 via trusted CDN infrastructure.",
    },
    LolbasEntry {
        name: "chisel",
        mitre_techniques: &["T1572"],
        use_cases: UC_NETWORK,
        description: "TCP/UDP tunnel over HTTP; firewall bypass for C2.",
    },
    LolbasEntry {
        name: "sshuttle",
        mitre_techniques: &["T1090"],
        use_cases: UC_NETWORK,
        description: "VPN over SSH; network pivoting.",
    },
    LolbasEntry {
        name: "proxychains-ng",
        mitre_techniques: &["T1090"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1090"],
        use_cases: UC_NETWORK,
        description: "WireGuard mesh VPN; covert C2 network.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1110.002"],
        use_cases: UC_CREDENTIALS,
        description: "GPU password cracking; credential recovery.",
    },
    LolbasEntry {
        name: "frida",
        mitre_techniques: &["T1055"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Dynamic instrumentation; process injection and hook bypass.",
    },
    LolbasEntry {
        name: "radare2",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1055"],
        use_cases: UC_EXECUTE | UC_CREDENTIALS,
        description: "GNU debugger; process memory dump and shellcode injection.",
    },
    // Build tools
    LolbasEntry {
        name: "cmake",
    ...
    LolbasEntry {
        ...
        use_cases: UC_CREDENTIALS,
        description: "1Password CLI; Keychain/vault secret extraction.",
    },
    LolbasEntry {
        name: "bitwarden-cli",
        mitre_techniques: &["T1555"],
        use_cases: UC_CREDENTIALS,
        description: "Bitwarden CLI; password vault access.",
    },
    // Encryption / signing
    LolbasEntry {
        name: "openssl",
        mitre_techniques: &["T1552.004", "T1105"],
        use_cases: UC_CREDENTIALS | UC_DOWNLOAD | UC_DECODE,
        description: "TLS toolkit; self-signed C2 certs, data encryption, and file downloads.",
    },
    LolbasEntry {
        name: "gpg",
        mitre_techniques: &[],
        use_cases: UC_DECODE,
        description: "GnuPG; encrypted C2 and payload concealment.",
    },
    LolbasEntry {
        name: "age",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1567"],
        use_cases: UC_UPLOAD,
        description: "Cloud sync; mass exfiltration to cloud storage.",
    },
    LolbasEntry {
        name: "rsync",
        mitre_techniques: &["T1105", "T1039"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD | UC_NETWORK,
        description: "File sync; lateral movement data staging.",
    },
    LolbasEntry {
        name: "wget",
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD,
        description: "HTTP downloader; payload delivery.",
    },
    LolbasEntry {
        name: "aria2c",
        mitre_techniques: &["T1105"],
        use_cases: UC_DOWNLOAD,
        description: "Multi-protocol downloader; parallel payload staging.",
    },
    LolbasEntry {
        name: "restic",
        mitre_techniques: &["T1560"],
        use_cases: UC_ARCHIVE | UC_UPLOAD,
        description: "Backup tool; encrypted data exfiltration.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &[],
        use_cases: UC_RECON,
        description: "JSON processor; credential extraction from API responses.",
    },
    LolbasEntry {
        name: "expect",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Automation tool; interactive process exploitation.",
    },
    LolbasEntry {
        name: "screen",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE | UC_PERSIST,
        description: "Terminal multiplexer; persistent session.",
    },
    LolbasEntry {
        name: "tmux",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE | UC_PERSIST,
        description: "Terminal multiplexer; session hijacking and persistence.",
    },
    LolbasEntry {
        name: "imagemagick",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1574"],
        use_cases: UC_PERSIST,
        description: "File association; handler hijacking for persistence.",
    },
    LolbasEntry {
        name: "trash",
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Move to Trash CLI; evidence staging before deletion.",
    },
];
...
pub const LOLBAS_WINDOWS_CMDLETS: &[LolbasEntry] = &[
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1021.006"],
        use_cases: UC_NETWORK | UC_EXECUTE,
        description: "Interactive PowerShell remote session; lateral movement.",
    },
    LolbasEntry {
        name: "Export-VM",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1482"],
        use_cases: UC_RECON,
        description: "Enumerate Active Directory trusts; map forest for lateral movement.",
    },
    LolbasEntry {
        name: "Get-ADUser",
        mitre_techniques: &["T1087.002"],
        use_cases: UC_RECON,
        description: "Enumerate AD users; target selection for credential attacks.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "List directory contents; filesystem enumeration.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1047"],
        use_cases: UC_RECON,
        description: "Modern WMI queries; system info, process, and network enumeration.",
    },
    LolbasEntry {
        name: "Get-DfsnFolder",
        mitre_techniques: &["T1135"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1057"],
        use_cases: UC_RECON,
        description: "Enumerate running processes; identify security tools and targets.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        use_cases: UC_RECON,
        description: "Enumerate Windows services; identify security products.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1135"],
        use_cases: UC_RECON,
        description: "Enumerate network shares; lateral movement target identification.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1654"],
        use_cases: UC_RECON,
        description: "Read Windows event logs; investigation evasion and log inspection.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1047"],
        use_cases: UC_EXECUTE,
        description: "Invoke WMI methods; remote process creation and service manipulation.",
    },
    LolbasEntry {
        name: "Invoke-Command",
        mitre_techniques: &["T1021.006"],
        use_cases: UC_EXECUTE | UC_NETWORK,
        description: "Execute commands on remote systems via WinRM; lateral movement.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        use_cases: UC_BYPASS,
        description: "Mount ISO/VHD to bypass Mark-of-the-Web.",
    },
    LolbasEntry {
        name: "Move-Item",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1136.001"],
        use_cases: UC_CREDENTIALS,
        description: "Create a new AD user account for persistence.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1021.006"],
        use_cases: UC_NETWORK,
        description: "Create persistent PS remote session; lateral movement.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1053.005"],
        use_cases: UC_PERSIST,
        description: "Register a scheduled task; persistence via task execution.",
    },
    LolbasEntry {
        name: "Remove-ADUser",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1018"],
        use_cases: UC_RECON,
        description: "DNS lookups; infrastructure mapping and C2 beacon testing.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1098"],
        use_cases: UC_CREDENTIALS,
        description: "Set an AD account password; credential manipulation for persistence.",
    },
    LolbasEntry {
        name: "Set-ADGroup",
        mitre_techniques: &["T1098"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1018"],
        use_cases: UC_RECON,
        description: "ICMP ping sweep; host discovery.",
    },
    LolbasEntry {
        name: "Test-NetConnection",
        mitre_techniques: &["T1046"],
        use_cases: UC_RECON,
        description: "TCP port scan and traceroute; network mapping.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Execute arbitrary PowerShell strings; primary AMSI bypass vehicle.",
    },
    LolbasEntry {
        name: "Invoke-WebRequest",
        mitre_techniques: &["T1059.001", "T1105"],
        use_cases: UC_DOWNLOAD | UC_EXECUTE,
        description: "HTTP/S download cmdlet; payload delivery and C2 communication.",
    },
    LolbasEntry {
        name: "Invoke-RestMethod",
        mitre_techniques: &["T1059.001", "T1071.001"],
        use_cases: UC_DOWNLOAD | UC_EXECUTE,
        description: "REST API client; C2 over HTTPS and payload retrieval.",
    },
    LolbasEntry {
        name: "Invoke-Item",
        mitre_techniques: &["T1204.002"],
        use_cases: UC_EXECUTE,
        description: "Execute file via shell association; run payloads without explicit path.",
    },
    LolbasEntry {
        name: "Start-Process",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Launch process with hidden window; stealthy process execution.",
    },
    LolbasEntry {
        name: "New-Object",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE | UC_DOWNLOAD,
        description: "Instantiate Net.WebClient, COM shell, ADODB.Stream for downloads.",
    },
    LolbasEntry {
        name: "Add-Type",
        mitre_techniques: &["T1620"],
        use_cases: UC_EXECUTE,
        description: "Compile and load C#/VB.NET inline; reflective code loading.",
    },
    LolbasEntry {
        name: "Start-Job",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Background execution to avoid blocking; evade timeout-based detections.",
    },
    LolbasEntry {
        name: "Import-Module",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Load PS modules and attack toolkits; import offensive frameworks.",
    },
    LolbasEntry {
        name: "Install-Module",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_DOWNLOAD | UC_EXECUTE,
        description: "Download modules from PSGallery; supply chain attack vector.",
    },
    //
    // ── Defense evasion ──────────────────────────────────────────────────────
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.001"],
        use_cases: UC_BYPASS,
        description: "Bypass script execution restrictions; enable unsigned script execution.",
    },
    LolbasEntry {
        name: "Unblock-File",
        mitre_techniques: &["T1553.005"],
        use_cases: UC_BYPASS,
        description: "Remove Zone.Identifier ADS; bypass Mark-of-the-Web.",
    },
    ...
    LolbasEntry {
        ...
        use_cases: UC_PERSIST,
        description: "Subscribe to .NET events for triggered execution.",
    },
    LolbasEntry {
        name: "Register-WmiEvent",
        mitre_techniques: &["T1546.003"],
        use_cases: UC_PERSIST,
        description: "WMI event subscription persistence; fileless trigger execution.",
    },
    LolbasEntry {
        name: "Set-ItemProperty",
        mitre_techniques: &["T1547.001"],
        use_cases: UC_PERSIST,
        description: "Write registry keys; Run key persistence.",
    },
    LolbasEntry {
        name: "New-ItemProperty",
        mitre_techniques: &["T1547.001"],
        use_cases: UC_PERSIST,
        description: "Create new registry values; persistence via Run key.",
    },
    LolbasEntry {
        name: "New-Service",
        mitre_techniques: &["T1543.003"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1543.003"],
        use_cases: UC_PERSIST,
        description: "Modify existing service config; hijack existing service.",
    },
    LolbasEntry {
        name: "Enable-PSRemoting",
        mitre_techniques: &["T1021.006"],
        use_cases: UC_NETWORK,
        description: "Enable WinRM remoting on target; lateral movement enablement.",
    },
    //
    // ── Discovery / reconnaissance ────────────────────────────────────────────
    ...
    LolbasEntry {
        ...
        use_cases: UC_RECON,
        description: "Read registry values; enumerate configuration and credentials.",
    },
    LolbasEntry {
        name: "Get-WmiObject",
        mitre_techniques: &["T1047"],
        use_cases: UC_RECON,
        description: "WMI queries for system info (PS 5.x); alias gwmi common in telemetry.",
    },
    LolbasEntry {
        name: "Get-LocalUser",
    ...
    LolbasEntry {
        ...
        use_cases: UC_RECON,
        description: "Enumerate local groups.",
    },
    LolbasEntry {
        name: "Get-LocalGroupMember",
        mitre_techniques: &["T1069.001"],
        use_cases: UC_RECON,
        description: "Enumerate group membership.",
    },
    LolbasEntry {
        name: "Get-ComputerInfo",
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "Full system fingerprint; comprehensive hardware and software inventory.",
    },
    LolbasEntry {
        name: "Test-Path",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Check file/registry existence; probe for security tool installations.",
    },
    //
    // ── Collection ───────────────────────────────────────────────────────────
    LolbasEntry {
        ...
        mitre_techniques: &["T1115"],
        use_cases: UC_RECON,
        description: "Steal clipboard contents; capture credentials and sensitive data.",
    },
    LolbasEntry {
        name: "Set-Clipboard",
        mitre_techniques: &["T1115"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1560.001"],
        use_cases: UC_ARCHIVE,
        description: "Zip files for staging before exfiltration.",
    },
    LolbasEntry {
        name: "Expand-Archive",
        mitre_techniques: &["T1560.001"],
        use_cases: UC_ARCHIVE,
        description: "Extract delivered payloads from archives.",
    },
    LolbasEntry {
        name: "Get-Content",
        mitre_techniques: &["T1005"],
        use_cases: UC_RECON,
        description: "Read file contents; exfiltrate credential files and configs.",
    },
    LolbasEntry {
        name: "Select-String",
        mitre_techniques: &["T1552.001"],
        use_cases: UC_RECON,
        description: "Regex search in files; grep for passwords in config files.",
    },
    LolbasEntry {
        name: "Set-Content",
        mitre_techniques: &[],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Delete files; anti-forensics and evidence removal.",
    },
    LolbasEntry {
        name: "Clear-EventLog",
        mitre_techniques: &["T1070.001"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1003"],
        use_cases: UC_CREDENTIALS,
        description: "Handle credential objects; construct credentials from plaintext.",
    },
    LolbasEntry {
        name: "ConvertFrom-SecureString",
        mitre_techniques: &["T1003"],
        use_cases: UC_CREDENTIALS,
        description: "Extract plaintext from secure strings; credential decryption.",
    },
    LolbasEntry {
        name: "Get-Credential",
        mitre_techniques: &["T1056.002"],
        use_cases: UC_CREDENTIALS,
        description: "Prompt user for credentials; interactive credential capture.",
    },
    LolbasEntry {
        name: "Export-Clixml",
        mitre_techniques: &["T1003"],
        use_cases: UC_CREDENTIALS,
        description: "Serialize credentials to XML; credential theft and portability.",
    },
    LolbasEntry {
        name: "Import-Clixml",
        mitre_techniques: &["T1003"],
        use_cases: UC_CREDENTIALS,
        description: "Deserialize saved credentials; replay stolen credential objects.",
    },
    //
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1047"],
        use_cases: UC_EXECUTE | UC_NETWORK,
        description: "Remote WMI method execution; lateral movement via WMI.",
    },
    //
    // ── Network ───────────────────────────────────────────────────────────────
    LolbasEntry {
        ...
        mitre_techniques: &["T1197"],
        use_cases: UC_DOWNLOAD | UC_UPLOAD,
        description: "BITS job for stealthy download/upload; evade proxy inspection.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE | UC_BYPASS,
        description: "Built-in alias for Invoke-Expression; canonical download-and-execute alias.",
    },
    LolbasEntry {
        name: "iwr",
        mitre_techniques: &["T1059.001", "T1105"],
        use_cases: UC_DOWNLOAD,
        description: "Invoke-WebRequest alias; payload download shorthand.",
    },
    LolbasEntry {
        name: "irm",
        mitre_techniques: &["T1059.001", "T1071.001"],
        use_cases: UC_DOWNLOAD,
        description: "Invoke-RestMethod alias; C2 over HTTPS shorthand.",
    },
    LolbasEntry {
        name: "icm",
        mitre_techniques: &["T1021.006"],
        use_cases: UC_EXECUTE | UC_NETWORK,
        description: "Invoke-Command alias; remote execution shorthand.",
    },
    LolbasEntry {
        name: "ii",
        mitre_techniques: &["T1204.002"],
        use_cases: UC_EXECUTE,
        description: "Invoke-Item alias.",
    },
    LolbasEntry {
        name: "saps",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Start-Process alias.",
    },
    LolbasEntry {
        name: "start",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Start-Process alias; common in one-liner payloads.",
    },
    LolbasEntry {
        name: "ipmo",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Import-Module alias; load offensive modules.",
    },
    LolbasEntry {
        name: "sajb",
        mitre_techniques: &["T1059.001"],
        use_cases: UC_EXECUTE,
        description: "Start-Job alias; background execution.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1047"],
        use_cases: UC_RECON,
        description: "Get-WmiObject alias; extremely common in attack telemetry.",
    },
    LolbasEntry {
        name: "iwmi",
        mitre_techniques: &["T1047"],
        use_cases: UC_EXECUTE,
        description: "Invoke-WmiMethod alias (PS 5.x only).",
    },
    // Discovery
    LolbasEntry {
        name: "gci",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Get-ChildItem alias; directory enumeration.",
    },
    LolbasEntry {
        name: "ls",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Get-ChildItem alias (PS); shadows Unix ls.",
    },
    LolbasEntry {
        name: "dir",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Get-ChildItem alias; directory listing.",
    },
    LolbasEntry {
        name: "gps",
        mitre_techniques: &["T1057"],
        use_cases: UC_RECON,
        description: "Get-Process alias.",
    },
    LolbasEntry {
        name: "ps",
        mitre_techniques: &["T1057"],
        use_cases: UC_RECON,
        description: "Get-Process alias; shadows Unix ps.",
    },
    LolbasEntry {
        name: "gsv",
        mitre_techniques: &["T1007"],
        use_cases: UC_RECON,
        description: "Get-Service alias.",
    },
    // Collection
    LolbasEntry {
        name: "gc",
        mitre_techniques: &["T1005"],
        use_cases: UC_RECON,
        description: "Get-Content alias.",
    },
    LolbasEntry {
        name: "cat",
        mitre_techniques: &["T1005"],
        use_cases: UC_RECON,
        description: "Get-Content alias; shadows Unix cat.",
    },
    LolbasEntry {
        name: "type",
        mitre_techniques: &["T1005"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1552.001"],
        use_cases: UC_RECON,
        description: "Select-String alias; credential file grep.",
    },
    LolbasEntry {
        name: "gp",
        mitre_techniques: &["T1012"],
        use_cases: UC_RECON,
        description: "Get-ItemProperty alias; registry value enumeration.",
    },
    // File manipulation
    LolbasEntry {
        name: "cp",
        mitre_techniques: &["T1074.001"],
        use_cases: UC_EXECUTE,
        description: "Copy-Item alias; file staging.",
    },
    LolbasEntry {
        name: "cpi",
        mitre_techniques: &["T1074.001"],
        use_cases: UC_EXECUTE,
        description: "Copy-Item alias.",
    },
    LolbasEntry {
        name: "copy",
        mitre_techniques: &["T1074.001"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Remove-Item alias; file deletion for anti-forensics.",
    },
    LolbasEntry {
        name: "ri",
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Remove-Item alias.",
    },
    LolbasEntry {
        name: "del",
        mitre_techniques: &["T1070.004"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Remove-Item alias; directory removal.",
    },
    LolbasEntry {
        name: "rmdir",
        mitre_techniques: &["T1070.004"],
        use_cases: UC_DEFENSE_EVASION,
        description: "Remove-Item alias; recursive directory deletion.",
    },
    LolbasEntry {
        name: "ni",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "New-Item alias.",
    },
    LolbasEntry {
        name: "ac",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Add-Content alias.",
    },
    LolbasEntry {
        name: "sc",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Set-Content alias (PS5 only — conflicts with sc.exe Service Control).",
    },
    LolbasEntry {
        name: "si",
        mitre_techniques: &[],
        use_cases: UC_EXECUTE,
        description: "Set-Item alias.",
    },
    LolbasEntry {
        name: "sp",
        mitre_techniques: &["T1547.001"],
        use_cases: UC_PERSIST,
        description: "Set-ItemProperty alias; registry persistence shorthand.",
    },
    // Process/service
    LolbasEntry {
        name: "spps",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1543.003"],
        use_cases: UC_EXECUTE,
        description: "Start-Service alias.",
    },
    LolbasEntry {
        name: "spsv",
        mitre_techniques: &["T1562.001"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1021.006"],
        use_cases: UC_NETWORK,
        description: "Enter-PSSession alias; lateral movement shorthand.",
    },
    LolbasEntry {
        name: "nsn",
        mitre_techniques: &["T1021.006"],
        use_cases: UC_NETWORK,
        description: "New-PSSession alias.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1059.001", "T1105"],
        use_cases: UC_DOWNLOAD,
        description: "Invoke-WebRequest alias (PS5.x only); shadows /usr/bin/wget.",
    },
    LolbasEntry {
        name: "curl",
        mitre_techniques: &["T1059.001", "T1105"],
        use_cases: UC_DOWNLOAD,
        description: "Invoke-WebRequest alias (PS5.x only); shadows /usr/bin/curl.",
    },
];
...
pub const LOLBAS_WINDOWS_MMC: &[LolbasEntry] = &[
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Authorization Manager; RBAC policy inspection.",
    },
    LolbasEntry {
        name: "certlm.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Local Machine certificate store.",
    },
    LolbasEntry {
        name: "certmgr.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Personal certificate store.",
    },
    LolbasEntry {
        name: "certsrv.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Certificate Authority management; PKI recon.",
    },
    LolbasEntry {
        name: "certtmpl.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON | UC_BYPASS,
        description: "Certificate Templates; template abuse for privilege escalation.",
    },
    LolbasEntry {
        name: "ipsecsnp.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "IPsec security policy.",
    },
    LolbasEntry {
        name: "ipsmsnap.msc",
        mitre_techniques: &["T1218.014"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "AD FS Identity Server.",
    },
    LolbasEntry {
        name: "ocsp.msc",
        mitre_techniques: &["T1218.014"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "PKI View; full CA chain enumeration.",
    },
    LolbasEntry {
        name: "secpol.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON | UC_BYPASS,
        description: "Local Security Policy; audit policy and user rights assignment.",
    },
    LolbasEntry {
        name: "tpm.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "TPM Management.",
    },
    LolbasEntry {
        name: "wsecedit.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Security Configuration Editor.",
    },
    // Active Directory / directory services
    LolbasEntry {
        name: "adsiedit.msc",
        mitre_techniques: &["T1218.014", "T1087.002"],
        use_cases: UC_RECON | UC_CREDENTIALS,
        description: "ADSI Edit; low-level AD object manipulation and modification.",
    },
    LolbasEntry {
        name: "domain.msc",
        mitre_techniques: &["T1218.014", "T1482"],
        use_cases: UC_RECON,
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Active Directory Schema; schema enumeration.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Component Services (COM+); COM object registration.",
    },
    LolbasEntry {
        name: "compmgmt.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Computer Management; unified admin console.",
    },
    LolbasEntry {
        name: "devmgmt.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Device Manager; driver enumeration and device info.",
    },
    LolbasEntry {
        name: "DevModeRunAsUserConfig.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Developer mode user config.",
    },
    LolbasEntry {
        name: "diskmgmt.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Disk Management; partition and volume enumeration.",
    },
    LolbasEntry {
        name: "lusrmgr.msc",
        mitre_techniques: &["T1218.014", "T1087.001"],
        use_cases: UC_RECON,
        description: "Local Users and Groups; user/group enumeration.",
    },
    // Group Policy
    LolbasEntry {
        name: "gpedit.msc",
        mitre_techniques: &["T1218.014", "T1484.001"],
        use_cases: UC_RECON | UC_BYPASS,
        description: "Local Group Policy Editor; policy modification.",
    },
    LolbasEntry {
        name: "gpmc.msc",
        mitre_techniques: &["T1218.014", "T1484.001"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Group Policy Template Editor.",
    },
    LolbasEntry {
        name: "rsop.msc",
        mitre_techniques: &["T1218.014", "T1615"],
        use_cases: UC_RECON,
        description: "Resultant Set of Policy; effective policy recon.",
    },
    ...
    LolbasEntry {
        name: "dfsmgmt.msc",
        mitre_techniques: &["T1218.014", "T1135"],
        use_cases: UC_RECON,
        description: "DFS Management; share enumeration.",
    },
    LolbasEntry {
        name: "dhcpmgmt.msc",
        mitre_techniques: &["T1218.014"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014", "T1135"],
        use_cases: UC_RECON,
        description: "NFS Management.",
    },
    LolbasEntry {
        name: "nps.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Network Policy Server (RADIUS).",
    },
    LolbasEntry {
        name: "RAMgmtUI.msc",
        mitre_techniques: &["T1218.014"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Telephony (TAPI).",
    },
    LolbasEntry {
        name: "winsmgmt.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "WINS Server Management.",
    },
    // Storage
    LolbasEntry {
        name: "fsmgmt.msc",
        mitre_techniques: &["T1218.014", "T1135"],
        use_cases: UC_RECON,
        description: "Shared Folders; network share enumeration.",
    },
    LolbasEntry {
        name: "fsrm.msc",
        mitre_techniques: &["T1218.014"],
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Remote Desktop Licensing Diagnostics.",
    },
    LolbasEntry {
        name: "perfmon.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "Performance Monitor; process/resource telemetry.",
    },
    // IIS / web / print / fax
    LolbasEntry {
        name: "fxsadmin.msc",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "IIS Manager (IIS 6 compat).",
    },
    LolbasEntry {
        name: "iis6.msc",
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "IIS 6 Manager.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "RemoteApp Programs.",
    },
    // Services / event log / scheduler
    LolbasEntry {
        name: "eventvwr.msc",
        mitre_techniques: &["T1218.014", "T1654"],
        use_cases: UC_RECON,
        description: "Event Viewer; log inspection and UAC bypass vector.",
    },
    LolbasEntry {
        name: "services.msc",
        mitre_techniques: &["T1218.014", "T1543.003"],
        use_cases: UC_RECON,
        description: "Services; service enumeration and manipulation.",
    },
    LolbasEntry {
        name: "taskschd.msc",
        mitre_techniques: &["T1218.014", "T1053.005"],
        use_cases: UC_RECON | UC_PERSIST,
        description: "Task Scheduler; scheduled task persistence.",
    },
    // Virtualization / SQL
    LolbasEntry {
        name: "virtmgmt.msc",
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1218.014"],
        use_cases: UC_RECON,
        description: "RD Session Host Configuration.",
    },
    LolbasEntry {
        name: "tsgateway.msc",
        mitre_techniques: &["T1218.014"],
    ...
    LolbasEntry {
        name: "WmiMgmt.msc",
        mitre_techniques: &["T1218.014", "T1047"],
        use_cases: UC_RECON,
        description: "WMI Control; WMI namespace permissions.",
    },
    LolbasEntry {
        name: "wsus.msc",
        mitre_techniques: &["T1218.014"],
...
pub const LOLBAS_WINDOWS_WMI: &[LolbasEntry] = &[
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1047"],
        use_cases: UC_EXECUTE,
        description: "Create/terminate processes; primary WMI remote execution vector.",
    },
    LolbasEntry {
        name: "Win32_ProcessStartup",
        mitre_techniques: &["T1047"],
        use_cases: UC_EXECUTE,
        description: "Process startup configuration for WMI-launched processes.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1546.003"],
        use_cases: UC_PERSIST,
        description: "WMI event filter; subscribe to system events for triggered execution.",
    },
    LolbasEntry {
        name: "__EventConsumer",
        mitre_techniques: &["T1546.003"],
        use_cases: UC_PERSIST,
        description: "WMI event consumer base class; action taken on matched event.",
    },
    LolbasEntry {
        name: "__FilterToConsumerBinding",
        mitre_techniques: &["T1546.003"],
        use_cases: UC_PERSIST,
        description: "Binds filter to consumer; completes WMI subscription persistence chain.",
    },
    LolbasEntry {
        name: "ActiveScriptEventConsumer",
        mitre_techniques: &["T1546.003"],
        use_cases: UC_PERSIST | UC_EXECUTE,
        description: "Run VBScript/JScript on WMI event; fileless persistence.",
    },
    LolbasEntry {
        name: "CommandLineEventConsumer",
        mitre_techniques: &["T1546.003"],
        use_cases: UC_PERSIST | UC_EXECUTE,
        description: "Run executable on WMI event; persistence and code execution.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "Hostname, domain, RAM, architecture; system fingerprint.",
    },
    LolbasEntry {
        name: "Win32_OperatingSystem",
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "OS version, install date, last boot; system enumeration.",
    },
    LolbasEntry {
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1654"],
        use_cases: UC_RECON,
        description: "Event log query via WMI.",
    },
    LolbasEntry {
        name: "Win32_QuickFixEngineering",
        mitre_techniques: &["T1518"],
        use_cases: UC_RECON,
        description: "Installed hotfix/patch enumeration.",
    },
    LolbasEntry {
        name: "CIM_DataFile",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "File system query by attribute; file discovery via WMI.",
    },
    LolbasEntry {
        name: "CIM_Directory",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Directory enumeration via WMI.",
    },
    LolbasEntry {
        name: "CIM_LogicalFile",
        mitre_techniques: &["T1083"],
        use_cases: UC_RECON,
        description: "Logical file metadata query.",
    },
    LolbasEntry {
        name: "MSFT_DNSClientCache",
        mitre_techniques: &["T1016"],
        use_cases: UC_RECON,
        description: "DNS cache inspection; network reconnaissance.",
    },
    LolbasEntry {
        name: "MSFT_MTProcess",
        mitre_techniques: &["T1057"],
        use_cases: UC_RECON,
        description: "Modern process telemetry.",
    },
    LolbasEntry {
        name: "MSFT_NetFirewallRule",
        mitre_techniques: &["T1016"],
        use_cases: UC_RECON,
        description: "Firewall rule enumeration; discover security controls.",
    },
    LolbasEntry {
        name: "Win32_DfsNode",
        mitre_techniques: &["T1135"],
        use_cases: UC_RECON,
        description: "DFS namespace enumeration; share discovery.",
    },
    // T1543.003 / T1489 — Service manipulation
    LolbasEntry {
        name: "Win32_Service",
        mitre_techniques: &["T1543.003", "T1489"],
        use_cases: UC_RECON | UC_PERSIST,
        description: "Service enumeration, start/stop, and persistence via WMI.",
    },
    LolbasEntry {
        name: "Win32_SystemDriver",
        mitre_techniques: &["T1082"],
        use_cases: UC_RECON,
        description: "Kernel driver enumeration; rootkit and AV detection.",
    },
    ...
    LolbasEntry {
        ...
        mitre_techniques: &["T1490"],
        use_cases: UC_DEFENSE_EVASION,
        description: "VSS snapshot deletion; inhibit system recovery (ransomware vector).",
    },
    ...
    LolbasEntry {
        name: "StdRegProv",
        mitre_techniques: &["T1552", "T1112"],
        use_cases: UC_CREDENTIALS | UC_PERSIST,
        description: "Registry read/write via WMI; credential and config access.",
    },
...
mod tests {
    ...
    fn lolbas_windows_contains_desktopimgdownldr() {
        ...
        assert!(LOLBAS_WINDOWS
            .iter()
            .any(|e| e.name == "desktopimgdownldr.exe"));
    }
    #[test]
    ...
    fn lolbas_windows_contains_infdefaultinstall() {
        ...
        assert!(LOLBAS_WINDOWS
            .iter()
            .any(|e| e.name == "infdefaultinstall.exe"));
    }
    #[test]
    ...
    fn lolbas_windows_contains_devtoolslauncher() {
        ...
        assert!(LOLBAS_WINDOWS
            .iter()
            .any(|e| e.name == "Devtoolslauncher.exe"));
    }
    #[test]
