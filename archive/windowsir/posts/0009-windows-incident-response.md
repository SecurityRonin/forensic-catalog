...
- URL: https://windowsir.blogspot.com/2006/09/gromozon-rootkit.html
- Published: unknown
- Updated: unknown
- Labels: none
...
as well as the book I co-authored with Cory Altheide, "Digital Forensics with Open Source Tools".
 ...
 PrevX's removal tool
 Instructions from 2-Spyware.com
 SWZone
 ...
 2 comments:
 Of course, if you surf the web while running as Administrator, as users must to be infected...

 - Rossetoecioccolato.
 Can you please add SpyWall to the list of tools that can remove Gromozon.
