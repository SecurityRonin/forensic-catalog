...
Generated from:
- feeds: `archive/sources/dfir-feeds.opml`
- directories: `archive/sources/catalog-directories.json`
- manual additions: `archive/sources/manual-sources.json`
...
- aboutDFIR blogs index: https://aboutdfir.com/reading/blogs/
  update: `manual-review`; kind: `blog-directory`; sources: `catalog-directory`
- aboutDFIR Forensicators of DFIR: https://aboutdfir.com/the-community/forensicators-of-dfir/
  update: `manual-review`; kind: `community-directory`; sources: `catalog-directory`
- CrowdStrike From the Front Lines: https://www.crowdstrike.com/en-us/blog/category.from-the-front-lines/
  update: `manual-review`; kind: `category-page`; sources: `catalog-directory`
